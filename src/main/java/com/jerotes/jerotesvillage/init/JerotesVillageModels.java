...
import com.jerotes.jerotesvillage.client.model.*;
...
public class JerotesVillageModels {
	@SubscribeEvent
	public static void registerLayerDefinitions(EntityRenderersEvent.RegisterLayerDefinitions event) {

		event.registerLayerDefinition(Modelcarved_iron_golem.LAYER_LOCATION, Modelcarved_iron_golem::createBodyLayer);
		event.registerLayerDefinition(Modelspear_machine.LAYER_LOCATION, Modelspear_machine::createBodyLayer);
		event.registerLayerDefinition(Modelunicycle.LAYER_LOCATION, Modelunicycle::createBodyLayer);
