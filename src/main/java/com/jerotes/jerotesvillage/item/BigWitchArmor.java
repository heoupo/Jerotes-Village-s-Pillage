...
import com.jerotes.jerotesvillage.client.model.Modelbig_witchs_hat;
...
public abstract class BigWitchArmor extends ArmorItem implements ItemModelArmor {
	public BigWitchArmor(Type type, Properties properties) {
	...
	public void initializeClient(Consumer<IClientItemExtensions> consumer) {
		...
		consumer.accept(new IClientItemExtensions() {
			public HumanoidModel<?> getHumanoidArmorModel(LivingEntity livingEntity, ItemStack itemStack, EquipmentSlot equipmentSlot, HumanoidModel<?> original) {
				Modelbig_witchs_hat model = new Modelbig_witchs_hat(Minecraft.getInstance().getEntityModels().bakeLayer(
						Modelbig_witchs_hat.LAYER_LOCATION)).getArmor(livingEntity);
	...
	public static class Helmet extends BigWitchArmor {
		public Helmet() {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "jerotesvillage:textures/models/armor/big_witchs_hat_layer_1.png";
		}
	}
}
