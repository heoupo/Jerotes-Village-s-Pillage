...
public class Modelfury_blamer_necromancy_warlock<T extends FuryBlamerNecromancyWarlockEntity> extends Modelillagerlike_raider<T> {
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(JerotesVillage.MODID, "fury_blamer_necromancy_warlock"), "main");
	private final ModelPart head;
	private final ModelPart arms;

	public Modelfury_blamer_necromancy_warlock(ModelPart root) {
		super(root);
	...
	public void setupAnim(T t, float f, float f2, float f3, float f4, float f5) {
		...
		boolean flag = abstractillager$illagerarmpose == FuryBlamerNecromancyWarlockEntity.IllagerArmPose.CROSSED && !(t instanceof AlwaysShowArmIllagerEntity);
