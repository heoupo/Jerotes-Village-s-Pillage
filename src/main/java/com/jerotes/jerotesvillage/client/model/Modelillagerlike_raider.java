...
public class Modelillagerlike_raider<T extends IllagerLikeRaiderEntity> extends Modelspecial_action<T> {
	...
	public void setupAnim(T t, float f, float f2, float f3, float f4, float f5) {
		...
		IllagerLikeRaiderEntity.IllagerArmPose abstractillager$illagerarmpose = t.getArmPose();

		if (abstractillager$illagerarmpose == IllagerLikeRaiderEntity.IllagerArmPose.ATTACKING) {
		...
		} else if (abstractillager$illagerarmpose == IllagerLikeRaiderEntity.IllagerArmPose.SPELLCASTING) {
		...
		else if (abstractillager$illagerarmpose == IllagerLikeRaiderEntity.IllagerArmPose.BOW_AND_ARROW) {
		...
		else if (abstractillager$illagerarmpose == IllagerLikeRaiderEntity.IllagerArmPose.CROSSBOW_HOLD) {
			AnimationUtils.animateCrossbowHold(this.rightArm, this.leftArm, this.head, true);
		} 
		else if (abstractillager$illagerarmpose == IllagerLikeRaiderEntity.IllagerArmPose.CROSSBOW_CHARGE) {
			AnimationUtils.animateCrossbowCharge(this.rightArm, this.leftArm, t, true);
		} 
		else if (abstractillager$illagerarmpose == IllagerLikeRaiderEntity.IllagerArmPose.CELEBRATING) {
			this.rightArm.z = 0.0F;
			this.rightArm.x = -5.0F;
...
//			}
		...
		boolean flag = abstractillager$illagerarmpose == IllagerLikeRaiderEntity.IllagerArmPose.CROSSED;
