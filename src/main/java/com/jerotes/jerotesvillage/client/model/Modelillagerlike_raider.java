...
import com.jerotes.jerotesvillage.entity.Monster.IllagerFaction.IllagerLikeRaiderEntity;
...
public class Modelillagerlike_raider<T extends IllagerLikeRaiderEntity> extends Modelspecial_action<T> {
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(JerotesVillage.MODID, "illagerlike_raider"), "main");
	...
	public Modelillagerlike_raider(ModelPart root) {
		super(root);
	...
	public void setupAnim(T t, float f, float f2, float f3, float f4, float f5) {
		...
		FuryBlamerNecromancyWarlockEntity.IllagerArmPose abstractillager$illagerarmpose = t.getArmPose();

		if (abstractillager$illagerarmpose == FuryBlamerNecromancyWarlockEntity.IllagerArmPose.ATTACKING) {
		...
		} else if (abstractillager$illagerarmpose == FuryBlamerNecromancyWarlockEntity.IllagerArmPose.SPELLCASTING) {
		...
		else if (abstractillager$illagerarmpose == FuryBlamerNecromancyWarlockEntity.IllagerArmPose.BOW_AND_ARROW) {
		...
		else if (abstractillager$illagerarmpose == FuryBlamerNecromancyWarlockEntity.IllagerArmPose.CROSSBOW_HOLD) {
			AnimationUtils.animateCrossbowHold(this.rightArm, this.leftArm, this.head, true);
		} 
		else if (abstractillager$illagerarmpose == FuryBlamerNecromancyWarlockEntity.IllagerArmPose.CROSSBOW_CHARGE) {
			AnimationUtils.animateCrossbowCharge(this.rightArm, this.leftArm, t, true);
		} 
		else if (abstractillager$illagerarmpose == FuryBlamerNecromancyWarlockEntity.IllagerArmPose.CELEBRATING) {
			this.rightArm.z = 0.0F;
			this.rightArm.x = -5.0F;
...
//			}
		...
		boolean flag = abstractillager$illagerarmpose == FuryBlamerNecromancyWarlockEntity.IllagerArmPose.CROSSED;
