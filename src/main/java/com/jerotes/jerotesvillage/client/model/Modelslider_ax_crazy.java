...
public class Modelslider_ax_crazy<T extends SliderAxCrazyEntity> extends Modelillagerlike<T> {
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(JerotesVillage.MODID, "slider_ax_crazy"), "main");
	private final ModelPart head;
	private final ModelPart arms;

	public Modelslider_ax_crazy(ModelPart root) {
		super(root);
	...
	public void setupAnim(T t, float f, float f2, float f3, float f4, float f5) {
		...
		boolean flag = abstractillager$illagerarmpose == IllagerLikeEntity.IllagerArmPose.CROSSED && !(t instanceof AlwaysShowArmIllagerEntity);
