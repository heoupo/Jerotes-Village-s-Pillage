...
import com.jerotes.jerotesvillage.client.animation.AxCrazyAnimation;
...
public class Modelfury_slider_ax_crazy<T extends FurySliderAxCrazyEntity> extends Modelillagerlike_raider<T> {
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(JerotesVillage.MODID, "fury_slider_ax_crazy"), "main");
