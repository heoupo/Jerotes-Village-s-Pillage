...
public class SlaverySupervisorRenderer extends HumanoidMobRenderer<SlaverySupervisorEntity, Modelslavery_supervisor<SlaverySupervisorEntity>> {
    private static final ResourceLocation LOCATION = new ResourceLocation(JerotesVillage.MODID, "textures/entity/slavery_supervisor.png");
    private static final ResourceLocation ILLAGER_WITHER_LOCATION = new ResourceLocation(JerotesVillage.MODID, "textures/entity/slavery_supervisor_noble_by_illager_wither.png");
