...
public class BrightBolaRenderer<T extends BrightBolaEntity> extends EntityRenderer<T> {
    private static final ResourceLocation TEXTURE_LOCATION = new ResourceLocation(JerotesVillage.MODID, "textures/item/villager_metal_ingot.png");
    private final ItemRenderer itemRenderer;
    private final float scale;
    private final boolean fullBright;

    public BrightBolaRenderer(EntityRendererProvider.Context context, float f, boolean bl) {
        super(context);
    ...
    public BrightBolaRenderer(EntityRendererProvider.Context context) {
    ...
    @Override
    public ResourceLocation getTextureLocation(BrightBolaEntity tex) {
