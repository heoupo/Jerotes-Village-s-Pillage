...
import com.jerotes.jerotesvillage.client.model.Modelblaster;
...
public class BlasterRenderer extends HumanoidMobRenderer<BlasterEntity, Modelblaster<BlasterEntity>> {
    private static final ResourceLocation LOCATION = new ResourceLocation(JerotesVillage.MODID, "textures/entity/blaster.png");
