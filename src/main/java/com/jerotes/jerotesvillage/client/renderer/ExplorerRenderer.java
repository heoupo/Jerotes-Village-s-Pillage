...
public class ExplorerRenderer extends HumanoidMobRenderer<ExplorerEntity, Modelillager<ExplorerEntity>> {
    private static final ResourceLocation EXPLORER_LOCATION = new ResourceLocation(JerotesVillage.MODID, "textures/entity/explorer.png");
    private static final ResourceLocation KILLER_LOCATION = new ResourceLocation(JerotesVillage.MODID, "textures/entity/explorer_killer.png");
