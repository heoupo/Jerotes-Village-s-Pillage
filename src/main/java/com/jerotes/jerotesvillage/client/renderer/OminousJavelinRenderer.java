...
import com.jerotes.jerotesvillage.client.model.Modeljavelin;
...
public class OminousJavelinRenderer extends EntityRenderer<ThrownOminousJavalinEntity> {
	private static final ResourceLocation texture = new ResourceLocation(JerotesVillage.MODID, "textures/item/ominous_javelin_model.png");
