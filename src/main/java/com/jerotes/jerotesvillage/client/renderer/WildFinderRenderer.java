...
import com.jerotes.jerotesvillage.client.model.Modelwild_finder;
...
public class WildFinderRenderer extends HumanoidMobRenderer<WildFinderEntity, Modelwild_finder<WildFinderEntity>> {
    private static final ResourceLocation LOCATION = new ResourceLocation(JerotesVillage.MODID, "textures/entity/illager/wild_finder.png");
    private static final ResourceLocation ILLAGER_WITHER_LOCATION = new ResourceLocation(JerotesVillage.MODID, "textures/entity/illager/wild_finder_leader_by_illager_wither.png");
