...
import com.jerotes.jerotesvillage.entity.Monster.IllagerFaction.MapmakerEntity;
...
public class MapmakerRenderer extends HumanoidMobRenderer<MapmakerEntity, Modelillager<MapmakerEntity>> {
    private static final ResourceLocation LOCATION = new ResourceLocation(JerotesVillage.MODID, "textures/entity/mapmaker.png");
    public MapmakerRenderer(EntityRendererProvider.Context context) {
    ...
    @Override
    protected void scale(MapmakerEntity entity, PoseStack poseStack, float f) {
        poseStack.scale(0.9375F, 0.9375F, 0.9375F);
        super.scale(entity, poseStack, f);
    }

    @Override
    public ResourceLocation getTextureLocation(MapmakerEntity entity) {
