...
import com.jerotes.jerotesvillage.client.model.Modelblamer_necromancy_warlock;
...
public class BlamerNecromancyWarlockRenderer extends HumanoidMobRenderer<BlamerNecromancyWarlockEntity, Modelblamer_necromancy_warlock<BlamerNecromancyWarlockEntity>> {
    private static final ResourceLocation LOCATION = new ResourceLocation(JerotesVillage.MODID, "textures/entity/blamer_necromancy_warlock.png");
    private static final ResourceLocation FURY_LOCATION = new ResourceLocation(JerotesVillage.MODID, "textures/entity/fury_blamer_necromancy_warlock.png");
