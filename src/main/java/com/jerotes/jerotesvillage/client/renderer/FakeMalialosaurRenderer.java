...
import com.jerotes.jerotesvillage.client.model.Modelfake_malialosaur;
import com.jerotes.jerotesvillage.entity.Animal.FakeMalialosaurEntity;
...
public class FakeMalialosaurRenderer extends MobRenderer<FakeMalialosaurEntity, Modelfake_malialosaur<FakeMalialosaurEntity>> {
	private static final ResourceLocation LOCATION = new ResourceLocation(JerotesVillage.MODID, "textures/entity/fake_malialosaur.png");
	private static final ResourceLocation TAME_LOCATION = new ResourceLocation(JerotesVillage.MODID, "textures/entity/fake_malialosaur_tame.png");
	private static final ResourceLocation SADDLE_LOCATION = new ResourceLocation(JerotesVillage.MODID, "textures/entity/fake_malialosaur_saddle.png");
