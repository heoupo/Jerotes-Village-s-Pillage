...
import com.jerotes.jerotesvillage.client.model.Modelbanner_bearer;
...
public class BannerBearerRenderer extends HumanoidMobRenderer<BannerBearerEntity, Modelbanner_bearer<BannerBearerEntity>> {
    private static final ResourceLocation LOCATION = new ResourceLocation(JerotesVillage.MODID, "textures/entity/banner_bearer.png");
    ...
    public ResourceLocation getTextureLocation(BannerBearerEntity entity) {
        ...
        if ("Flag Zombie".equals(string)) {
            return new ResourceLocation(JerotesVillage.MODID, "textures/entity/banner_bearer_flag_zombie_by_jiliuwanye.png");
        }
        return LOCATION;
    }
}
