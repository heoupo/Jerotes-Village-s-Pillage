...
import com.jerotes.jerotesvillage.entity.Monster.IllagerFaction.ZombieKeeperEntity;
...
public class ZombieKeeperRenderer extends HumanoidMobRenderer<ZombieKeeperEntity, Modelillager<ZombieKeeperEntity>> {
    private static final ResourceLocation LOCATION = new ResourceLocation(JerotesVillage.MODID, "textures/entity/zombie_keeper.png");
    public ZombieKeeperRenderer(EntityRendererProvider.Context context) {
    ...
    @Override
    protected void scale(ZombieKeeperEntity entity, PoseStack poseStack, float f) {
        poseStack.scale(0.9375F, 0.9375F, 0.9375F);
        super.scale(entity, poseStack, f);
    }

    @Override
    public ResourceLocation getTextureLocation(ZombieKeeperEntity entity) {
