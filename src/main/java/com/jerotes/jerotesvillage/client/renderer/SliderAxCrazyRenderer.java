...
public class SliderAxCrazyRenderer extends HumanoidMobRenderer<SliderAxCrazyEntity, Modelslider_ax_crazy<SliderAxCrazyEntity>> {
    private static final ResourceLocation LOCATION = new ResourceLocation(JerotesVillage.MODID, "textures/entity/illager/slider_ax_crazy.png");
    private static final ResourceLocation GLOW_LOCATION = new ResourceLocation(JerotesVillage.MODID, "textures/entity/illager/slider_ax_crazy_glow.png");
    public SliderAxCrazyRenderer(EntityRendererProvider.Context context) {
        super(context, new Modelslider_ax_crazy(context.bakeLayer(Modelslider_ax_crazy.LAYER_LOCATION)), 0.5f);
        this.addLayer(new GlowOtherBodyLayer<>(this, new Modelslider_ax_crazy(context.bakeLayer(Modelslider_ax_crazy.LAYER_LOCATION)), GLOW_LOCATION));
    ...
    @Override
    protected void scale(SliderAxCrazyEntity entity, PoseStack poseStack, float f) {
        poseStack.scale(0.9375F, 0.9375F, 0.9375F);
        super.scale(entity, poseStack, f);
    }

    @Override
    protected float getFlipDegrees(SliderAxCrazyEntity entity) {
        return 0.0f;
    }

    @Override
    protected boolean isShaking(SliderAxCrazyEntity entity) {
        String string = ChatFormatting.stripFormatting(entity.getName().getString());
        return entity.isAggressive() && super.isShaking(entity);
    }

    @Override
    public ResourceLocation getTextureLocation(SliderAxCrazyEntity t) {
    ...
    @Override
    protected void setupRotations(SliderAxCrazyEntity entity, PoseStack poseStack, float f, float f2, float f3) {
