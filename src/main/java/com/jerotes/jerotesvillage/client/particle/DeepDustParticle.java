...
@OnlyIn(Dist.CLIENT)
public class DeepDustParticle extends TextureSheetParticle {
	...
	public static class DisplayParticleProvider implements ParticleProvider<SimpleParticleType> {
		...
		public Particle createParticle(SimpleParticleType typeIn, ClientLevel worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
			return new DeepDustParticle(worldIn, x, y, z, xSpeed, ySpeed, zSpeed, this.spriteSet);
		}
	}

	private final SpriteSet spriteSet;

	protected DeepDustParticle(ClientLevel world, double x, double y, double z, double vx, double vy, double vz, SpriteSet spriteSet) {
		super(world, x, y, z);
		this.spriteSet = spriteSet;
	...
	public float getQuadSize(float f) {
		return this.quadSize * (1 - Mth.clamp(((float)this.age + f) / (float)this.lifetime * 0.6f, 0.0f, 1.0f));
	}
