...
public class BossShowEntity extends LivingEntity {
	...
	public InteractionResult interactAt(Player player, Vec3 vec3, InteractionHand interactionHand) {
		...
		//灾厄旗帜投影
		if (this.getType() == JerotesVillageEntityType.BOSS_SHOW_ENTITY_OMINOUS_BANNER_PROJECTION.get())
			soundEvent = JerotesVillageSoundEvents.OMINOUS_BANNER_PROJECTION_AMBIENT;
		//紫沙鬼婆
		if (this.getType() == JerotesVillageEntityType.BOSS_SHOW_ENTITY_PURPLE_SAND_HAG.get())
			soundEvent = JerotesVillageSoundEvents.PURPLE_SAND_HAG_AMBIENT;
