...
public class FakeMalialosaurPart extends PartEntity<FakeMalialosaurEntity> {
	public final FakeMalialosaurEntity parentMob;
	public final String name;
	private final EntityDimensions size;
	public float scale = 1;

	public FakeMalialosaurPart(FakeMalialosaurEntity parent, String p_31015_, float p_31016_, float p_31017_) {
		super(parent);
	...
	public boolean hurt(DamageSource damageSource, float p_31021_) {
		if (this.isVehicle() && damageSource.getEntity() != null && this.getPassengers().contains(damageSource.getEntity()))
			return false;
