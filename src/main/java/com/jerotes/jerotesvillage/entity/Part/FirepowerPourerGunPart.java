...
public class FirepowerPourerGunPart extends FirepowerPourerPart {
	public final FirepowerPourerEntity parentMob;
	public final String name;
	private final EntityDimensions size;

	public FirepowerPourerGunPart(FirepowerPourerEntity parent, String p_31015_, float p_31016_, float p_31017_) {
		super(parent);
...
//			serverPlayer.sendSystemMessage(Component.literal("gun"));
		return !this.isInvulnerableTo(damageSource) && this.parentMob.hurtByGunPart(damageSource, f);
	}
