...
public abstract class SerponDoorInteractGoal
extends Goal {
    protected Mob mob;
    ...
    public SerponDoorInteractGoal(Mob mob) {
        this.mob = mob;
    }
    ...
    public boolean canUse() {
        ...
        if (!(this.mob.getNavigation() instanceof FlyingPathNavigation groundPathNavigation)) {
            return false;
        }
