...
public abstract class GiantMonsterTargetGoal extends Goal {
    ...
    @Nullable
    protected GiantMonsterEntity targetMob;
    protected int unseenMemoryTicks = 60;

    public GiantMonsterTargetGoal(GiantMonsterEntity p_26140_, boolean p_26141_) {
        this(p_26140_, p_26141_, false);
    }

    public GiantMonsterTargetGoal(GiantMonsterEntity p_26143_, boolean p_26144_, boolean p_26145_) {
        this.mob = p_26143_;
    ...
    public GiantMonsterTargetGoal setUnseenMemoryTicks(int p_26147_) {
