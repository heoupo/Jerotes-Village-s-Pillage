...
import com.jerotes.jerotesvillage.block.Other.VillagerMetalDoor;
...
public abstract class VillagerMetalDoorInteractGoal
extends Goal {
    protected Mob mob;
    ...
    public VillagerMetalDoorInteractGoal(Mob mob) {
        this.mob = mob;
    }
    ...
    public boolean canUse() {
        ...
        PathNavigation groundPathNavigation = this.mob.getNavigation();
        ...
        for (int i = 0; i < Math.min(path.getNextNodeIndex() + 2, path.getNodeCount()); ++i) {
            ...
            this.hasDoor = this.mob.level().getBlockState(this.doorPos).getBlock() instanceof VillagerMetalDoor;
