package com.jerotes.jerotesvillage.world.features;

import com.jerotes.jerotesvillage.JerotesVillage;
import com.jerotes.jerotesvillage.world.features.configurations.StructureFeatureConfiguration;
...
public class StructureFeature extends Feature<StructureFeatureConfiguration> {
	public static final DeferredRegister<Feature<?>> REGISTRY = DeferredRegister.create(ForgeRegistries.FEATURES, JerotesVillage.MODID);
