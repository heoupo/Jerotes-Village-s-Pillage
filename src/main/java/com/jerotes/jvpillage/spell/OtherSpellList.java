...
public class OtherSpellList {
	...
	public static MagicSpell BloodyScream(int n, LivingEntity caster, Entity target) {
		return new MagicSpell(n, caster, target, MagicType.SHOOT, MagicType.MAIN, "bloody_scream", JVPillageParticleTypes.BLOODY_SCREAM_DISPLAY.get(), JVPillageSoundEvents.MAGIC_BLOODY_SCREAM){
	...
	public static MagicSpell PurpleSandPhantom(int n, LivingEntity caster, Entity target) {
		return new MagicSpell(n, caster, target, MagicType.TARGET, MagicType.MAIN, "purple_sand_phantom", JVPillageParticleTypes.PURPLE_SAND_PHANTOM_DISPLAY.get(), JVPillageSoundEvents.MAGIC_PURPLE_SAND_PHANTOM){
			public boolean spellFindUse() {
	...
	public static MagicSpell ElasticLightBall(int n, LivingEntity caster, Entity target) {
		return new MagicSpell(n, caster, target, MagicType.SHOOT, MagicType.MAIN, "elastic_light_ball", JVPillageParticleTypes.ELASTIC_LIGHT_BALL_DISPLAY.get(), JVPillageSoundEvents.MAGIC_ELASTIC_LIGHT_BALL){
			public boolean spellFindUse() {
	...
	public static MagicSpell RadiantBomb(int n, LivingEntity caster, Entity target) {
		return new MagicSpell(n, caster, target, MagicType.SHOOT, MagicType.MAIN, "radiant_bomb", JVPillageParticleTypes.RADIANT_BOMB_DISPLAY.get(), JVPillageSoundEvents.MAGIC_RADIANT_BOMB){
			public boolean spellFindUse() {
	...
	public static MagicSpell ArcaneLightSpot(int n, LivingEntity caster, Entity target) {
		return new MagicSpell(n, caster, target, MagicType.TARGET, MagicType.MAIN, "arcane_light_spot", JVPillageParticleTypes.ARCANE_LIGHT_SPOT_DISPLAY.get(), JVPillageSoundEvents.MAGIC_ARCANE_LIGHT_SPOT){
			public boolean spellFindUse() {
	...
	public static MagicSpell ElasticIceRock(int n, LivingEntity caster, Entity target) {
		return new MagicSpell(n, caster, target, MagicType.SHOOT, MagicType.MAIN, "elastic_ice_rock", JVPillageParticleTypes.ELASTIC_ICE_ROCK_DISPLAY.get(), JVPillageSoundEvents.MAGIC_ELASTIC_ICE_ROCK){
			public boolean spellFindUse() {
	...
	public static MagicSpell BloodyBlameSoulAssist(int n, LivingEntity caster, Entity target) {
		return new MagicSpell(n, caster, target, MagicType.SELF, MagicType.MAIN, "bloody_blame_soul_assist", JVPillageParticleTypes.BLOODY_BLAME_SOUL_ASSIST_DISPLAY.get(), JVPillageSoundEvents.MAGIC_BLOODY_BLAME_SOUL_ASSIST){
			public boolean spellFindUse() {
	...
	public static MagicSpell OminousFlames(int n, LivingEntity caster, Entity target) {
		return new MagicSpell(n, caster, target, MagicType.SHOOT, MagicType.MAIN, "ominous_flames", JVPillageParticleTypes.OMINOUS_FLAMES_DISPLAY.get(), JVPillageSoundEvents.MAGIC_OMINOUS_FLAMES){
			public boolean spellFindUse() {
	...
	public static MagicSpell PushForce(int n, LivingEntity caster, Entity target) {
		return new MagicSpell(n, caster, target, MagicType.SHOOT, MagicType.MAIN, "push_force", JVPillageParticleTypes.PUSH_FORCE_DISPLAY.get(), JVPillageSoundEvents.MAGIC_PUSH_FORCE){
			public boolean spellFindUse() {
	...
	public static MagicSpell GemstoneWaves(int n, LivingEntity caster, Entity target) {
		return new MagicSpell(n, caster, target, MagicType.SHOOT, MagicType.MAIN, "gemstone_waves", JVPillageParticleTypes.GEMSTONE_WAVES_DISPLAY.get(), JVPillageSoundEvents.MAGIC_GEMSTONE_WAVES){
			public boolean spellFindUse() {
	...
	public static MagicSpell GravityForce(int n, LivingEntity caster, Entity target) {
		return new MagicSpell(n, caster, target, MagicType.SELF, MagicType.MAIN, "gravity_force", JVPillageParticleTypes.GRAVITY_FORCE_DISPLAY.get(), JVPillageSoundEvents.MAGIC_GRAVITY_FORCE){
			public boolean spellFindUse() {
	...
	public static MagicSpell UncleanBloodRain(int n, LivingEntity caster, Entity target) {
		return new MagicSpell(n, caster, target, MagicType.TARGET, MagicType.MAIN, "unclean_blood_rain", JVPillageParticleTypes.UNCLEAN_BLOOD_RAIN_DISPLAY.get(), JVPillageSoundEvents.MAGIC_UNCLEAN_BLOOD_RAIN){
			public boolean spellFindUse() {
	...
	public static MagicSpell UncleanBloodFog(int n, LivingEntity caster, Entity target) {
		return new MagicSpell(n, caster, target, MagicType.TARGET, MagicType.MAIN, "unclean_blood_fog", JVPillageParticleTypes.UNCLEAN_BLOOD_FOG_DISPLAY.get(), JVPillageSoundEvents.MAGIC_UNCLEAN_BLOOD_FOG){
			public boolean spellFindUse() {
	...
	public static MagicSpell WarlockWhisper(int n, LivingEntity caster, Entity target) {
		return new MagicSpell(n, caster, target, MagicType.SHOOT, MagicType.MAIN, "warlock_whisper", JVPillageParticleTypes.WARLOCK_WHISPER_DISPLAY.get(), JVPillageSoundEvents.MAGIC_WARLOCK_WHISPER){
			public boolean spellFindUse() {
