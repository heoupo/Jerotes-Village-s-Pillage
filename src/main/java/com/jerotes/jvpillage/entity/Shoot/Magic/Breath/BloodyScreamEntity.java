package com.jerotes.jvpillage.entity.Shoot.Magic.Breath;
...
public class BloodyScreamEntity extends BaseBreathEntity {
    ...
    public BloodyScreamEntity(int spellLevelDamage, int spellLevelMainEffectTime, int spellLevelMainEffectLevel, Level level, LivingEntity livingEntity, double d, double d2, double d3) {
        super(JVPillageEntityType.BLOODY_SCREAM.get(), livingEntity, d, d2, d3, level);
    ...
    protected void onHitEntity(EntityHitResult entityHitResult) {
        ...
        if (entity instanceof LivingEntity livingEntity) {
            ...
            if (bl) {
                livingEntity.addEffect(new MobEffectInstance(JVPillageMobEffects.UNCLEAN_BODY.get(), 20 * spellLevelMainEffectTime, spellLevelMainEffectLevel - 1), this.getEffectSource());
            }
        }
    }
    ...
    public MobEffect getCloudEffect() {
        return JVPillageMobEffects.UNCLEAN_BODY.get();
    }
    ...
    protected ParticleOptions getTrailParticle() {
        return JVPillageParticleTypes.BLOODY_SCREAM.get();
    }

    @Override
    public ItemStack getItem() {
        ItemStack itemStack = this.getItemRaw();
        return itemStack.isEmpty() ? new ItemStack(JVPillageItems.BLOODY_SCREAM.get()) : itemStack;
    }
