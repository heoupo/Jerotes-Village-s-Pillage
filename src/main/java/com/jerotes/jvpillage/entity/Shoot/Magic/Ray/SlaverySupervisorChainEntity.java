...
public class SlaverySupervisorChainEntity extends BaseRayEntity {
    ...
    public SlaverySupervisorChainEntity(int spellLevelDamage, Level level, LivingEntity livingEntity, double d, double d2, double d3) {
        super(JVPillageEntityType.SLAVERY_SUPERVISOR_CHAIN.get(), livingEntity, d, d2, d3, level);
    ...
    public ItemStack getItem() {
        ...
        if (this.isUseful()) {
            return itemStack.isEmpty() ? new ItemStack(JVPillageItems.SLAVERY_SUPERVISOR_CHAIN.get()) : itemStack;
        }
