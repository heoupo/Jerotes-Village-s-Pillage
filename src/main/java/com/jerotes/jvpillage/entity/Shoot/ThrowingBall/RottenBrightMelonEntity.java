...
public class RottenBrightMelonEntity extends BaseThrowingBallEntity {
    ...
    public RottenBrightMelonEntity(Level level, LivingEntity livingEntity) {
        super(JVPillageEntityType.ROTTEN_BRIGHT_MELON.get(), livingEntity, level);
    }

    public RottenBrightMelonEntity(Level level, double d, double d2, double d3) {
        super(JVPillageEntityType.ROTTEN_BRIGHT_MELON.get(), d, d2, d3, level);
    }
    ...
    public ParticleOptions tailParticles() {
        return new ItemParticleOption(ParticleTypes.ITEM, new ItemStack(JVPillageItems.BRIGHT_MELON_SEEDS.get()));
    }
    @Override
    ...
    protected Item getDefaultItem() {
        return JVPillageItems.ROTTEN_BRIGHT_MELON.get();
    }
}
