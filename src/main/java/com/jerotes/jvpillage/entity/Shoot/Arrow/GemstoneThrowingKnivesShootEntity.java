...
public class GemstoneThrowingKnivesShootEntity extends BaseAbstractArrowEntity {
    ...
    public GemstoneThrowingKnivesShootEntity(Level level, LivingEntity livingEntity, ItemStack itemStack) {
        super(JVPillageEntityType.GEMSTONE_THROWING_KNIVES_SHOOT.get(), livingEntity, level, itemStack);
    ...
    public void playerTouch(Player player) {
        ...
        if (player.getItemInHand(InteractionHand.MAIN_HAND).getItem() == JVPillageItems.GEMSTONE_THROWING_KNIVES.get() && player.getItemInHand(InteractionHand.MAIN_HAND).getDamageValue() >= 1){
