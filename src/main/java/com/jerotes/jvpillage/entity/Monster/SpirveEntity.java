...
import com.jerotes.jvpillage.goal.SpirveOrHagAttackTargetGoal;
...
public class SpirveEntity extends Raider implements SpellUseEntity, UseDaggerEntity, ShiftKeyDownEntity, NeutralMob, WizardEntity, PurpleSandSisterhoodEntity, UseThrowEntity, UseThrownJavelinEntity, InventoryEntity, CrossbowAttackMob, UseCrossbowEntity, UseBowEntity, InventoryCarrier, UseShieldEntity, JerotesEntity, SkinEntity, LightningAbsorptionEntity {
	...
	protected void populateDefaultEquipmentSlots(RandomSource randomSource, DifficultyInstance difficultyInstance) {
		this.maybeWearArmor(EquipmentSlot.HEAD, new ItemStack(JVPillageItems.SPIRVE_HELMET.get()), randomSource);
		this.maybeWearArmor(EquipmentSlot.CHEST, new ItemStack(JVPillageItems.SPIRVE_CHESTPLATE.get()), randomSource);
		this.maybeWearArmor(EquipmentSlot.LEGS, new ItemStack(JVPillageItems.SPIRVE_LEGGINGS.get()), randomSource);
		this.maybeWearArmor(EquipmentSlot.FEET, new ItemStack(JVPillageItems.SPIRVE_BOOTS.get()), randomSource);
	}
	...
	protected void dropCustomDeathLoot(DamageSource damageSource, int n, boolean bl) {
		...
		if (entity instanceof Creeper && (creeper = (Creeper)entity).canDropMobsSkull()) {
			...
			this.spawnAtLocation(JVPillageItems.SPIRVE_HEAD.get());
		}
	}
	...
	protected SoundEvent getAmbientSound() {
		return JVPillageSoundEvents.SPIRVE_AMBIENT;
	}
	@Override
	protected SoundEvent getDeathSound() {
		return JVPillageSoundEvents.SPIRVE_DEATH;
	}
	@Override
	public SoundEvent getCelebrateSound() {
		return JVPillageSoundEvents.SPIRVE_CHEER;
	}
	@Override
	protected SoundEvent getHurtSound(DamageSource damageSource) {
		...
		return JVPillageSoundEvents.SPIRVE_HURT;
	}
	@Override
	...
	public ItemStack createSpawnWeapon(float weaponRandom) {
		if (weaponRandom > 0.96) {
			return new ItemStack(JVPillageItems.SPIRVE_BROOM.get());
		}
		if (weaponRandom > 0.92) {
			return new ItemStack(JVPillageItems.SPIRVE_DUSTPAN.get());
		}
		if (weaponRandom > 0.88) {
			return new ItemStack(JVPillageItems.SPIRVE_KITCHEN_KNIFE.get());
		}
		if (weaponRandom > 0.84) {
			return new ItemStack(JVPillageItems.SPIRVE_SPATULA.get());
		}
		if (weaponRandom > 0.80) {
			return new ItemStack(JVPillageItems.SPIRVE_PAN.get());
		}
		if (weaponRandom > 0.76) {
			return new ItemStack(JVPillageItems.SPIRVE_SAW.get());
		}
		if (weaponRandom > 0.72) {
			return new ItemStack(JVPillageItems.SPIRVE_PINCER.get());
		}
		if (weaponRandom > 0.68) {
			return new ItemStack(JVPillageItems.SPIRVE_SISSORS.get());
		}
		if (weaponRandom > 0.64) {
			return new ItemStack(JVPillageItems.SPIRVE_RAZOR.get());
		}
		if (weaponRandom > 0.60) {
			return new ItemStack(JVPillageItems.SPIRVE_DUSTER.get());
		}
		if (weaponRandom > 0.56) {
			return new ItemStack(JVPillageItems.SPIRVE_BROKEN_BOOTLE.get());
		}
		if (weaponRandom > 0.52) {
			return new ItemStack(JVPillageItems.SPIRVE_FORK.get());
		}
		if (weaponRandom > 0.48) {
			return new ItemStack(JVPillageItems.SPIRVE_STUB.get());
		}
		if (weaponRandom > 0.44) {
			return new ItemStack(JVPillageItems.SPIRVE_CHOPPER.get());
		}
		if (weaponRandom > 0.42) {
			return new ItemStack(JVPillageItems.SPIRVE_RULER.get());
		}
		if (weaponRandom > 0.40) {
			return new ItemStack(JVPillageItems.SPIRVE_WOODEN_BACK_SCRATCHER.get());
		}
		if (weaponRandom > 0.39) {
			return new ItemStack(JVPillageItems.SPIRVE_MORNING_STAR.get());
		}
		if (weaponRandom > 0.36) {
			return new ItemStack(JVPillageItems.SPIRVE_HAMMER.get());
		}
		if (weaponRandom > 0.34) {
			return new ItemStack(JVPillageItems.SPIRVE_FLAIL.get());
		}
		if (weaponRandom > 0.32) {
			return new ItemStack(JVPillageItems.SPIRVE_HORSEWHIP.get());
		}
		if (weaponRandom > 0.30) {
			return new ItemStack(JVPillageItems.SPIRVE_HOOK.get());
		}
		if (weaponRandom > 0.26) {
			return new ItemStack(JVPillageItems.SPIRVE_LADLE.get());
		}
		if (weaponRandom > 0.22) {
			return new ItemStack(JVPillageItems.SPIRVE_FIRESTICK.get());
		}
		if (weaponRandom > 0.18) {
			return new ItemStack(JVPillageItems.SPIRVE_SICKLE.get());
		}
		if (weaponRandom > 0.14) {
			return new ItemStack(JVPillageItems.SPIRVE_FRAME_SAW.get());
		}
		if (weaponRandom > 0.10) {
			return new ItemStack(JVPillageItems.SPIRVE_WRENCH.get());
		}
		if (weaponRandom > 0.06) {
			return new ItemStack(JVPillageItems.SPIRVE_MOP.get());
		}
		if (weaponRandom > 0.03) {
			return new ItemStack(JVPillageItems.SPIRVE_INSECT_NET.get());
		}
		if (weaponRandom > 0.02) {
			return new ItemStack(JVPillageItems.SPIRVE_GOURD_LADLE.get());
		}
	...
	public ItemStack createSpawnOffhand(float offhandRandom) {
		if (offhandRandom > 0.92) {
			return new ItemStack(JVPillageItems.SPIRVE_LID.get());
		}
