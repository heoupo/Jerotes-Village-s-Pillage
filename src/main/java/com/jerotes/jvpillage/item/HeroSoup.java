...
public class HeroSoup extends BowlFoodItem {
	public HeroSoup() {
		super(new Properties().stacksTo(1).rarity(Rarity.COMMON).food(JVPillageFoods.HERO_SOUP));
	}
	...
	public ItemStack finishUsingItem(ItemStack itemstack, Level level, LivingEntity entity) {
		...
		if (level.isClientSide) {
			Minecraft.getInstance().gameRenderer.displayItemActivation(new ItemStack(JVPillageItems.ABUNDANT_COURAGE.get()));
		}
