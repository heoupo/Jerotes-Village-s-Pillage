...
public class PurpleSandExplosiveAlchemyBomb extends Item implements JerotesItemThrowUse {
	public PurpleSandExplosiveAlchemyBomb() {
	...
	public Projectile useJerotesThrowShoot(LivingEntity livingEntity, InteractionHand interactionHand) {
		if (livingEntity.getItemInHand(interactionHand).getItem() instanceof PurpleSandExplosiveAlchemyBomb purpleSandExplosiveAlchemyBomb) {
			if (!livingEntity.level().isClientSide()) {
				PurpleSandExplosiveAlchemyBombEntity throwItem = new PurpleSandExplosiveAlchemyBombEntity(livingEntity.level(), livingEntity);
