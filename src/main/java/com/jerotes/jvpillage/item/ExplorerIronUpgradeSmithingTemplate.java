...
public class ExplorerIronUpgradeSmithingTemplate extends ItemBaseUpgradeSmithingTemplate {
	public ExplorerIronUpgradeSmithingTemplate() {
	...
	public void appendHoverText(ItemStack itemStack, @Nullable Level level, List<Component> list, TooltipFlag tooltipFlag) {
		...
		list.add(Component.translatable("item.minecraft.iron_ingot").withStyle(ChatFormatting.BLUE));
	}
