...
import com.jerotes.jvpillage.client.model.Modelexplorer_armor;
...
public abstract class ExplorerArmor extends ArmorItem {
	...
	public static class Helmet extends ExplorerArmor {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "jvpillage:textures/models/armor/explorer_helmet.png";
		}
	}
	...
	public static class Chestplate extends ExplorerArmor {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "jvpillage:textures/models/armor/explorer_chestplate.png";
		}
	}
	...
	public static class Leggings extends ExplorerArmor {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "jvpillage:textures/models/armor/explorer_leggings.png";
		}
	}
	...
	public static class Boots extends ExplorerArmor {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "jvpillage:textures/models/armor/explorer_boots.png";
		}
