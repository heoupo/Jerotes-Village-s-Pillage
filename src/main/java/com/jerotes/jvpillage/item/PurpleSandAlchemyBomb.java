...
public class PurpleSandAlchemyBomb extends Item implements JerotesItemThrowUse {
	public PurpleSandAlchemyBomb() {
	...
	public Projectile useJerotesThrowShoot(LivingEntity livingEntity, InteractionHand interactionHand) {
		if (livingEntity.getItemInHand(interactionHand).getItem() instanceof PurpleSandAlchemyBomb purpleSandExplosiveAlchemy) {
			if (!livingEntity.level().isClientSide()) {
				PurpleSandAlchemyBombEntity throwItem = new PurpleSandAlchemyBombEntity(livingEntity.level(), livingEntity);
