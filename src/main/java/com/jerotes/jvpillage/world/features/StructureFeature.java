package com.jerotes.jvpillage.world.features;

import com.jerotes.jvpillage.JVPillage;
import com.jerotes.jvpillage.world.features.configurations.StructureFeatureConfiguration;
...
public class StructureFeature extends Feature<StructureFeatureConfiguration> {
	public static final DeferredRegister<Feature<?>> REGISTRY = DeferredRegister.create(ForgeRegistries.FEATURES, JVPillage.MODID);
