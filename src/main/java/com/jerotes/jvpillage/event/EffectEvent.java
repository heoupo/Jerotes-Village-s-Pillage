...
public class EffectEvent {
	...
	public static void UncleanBody(LivingHurtEvent event) {
		...
		if (!entity.level().isClientSide()) {
			if (entity.hasEffect(JVPillageMobEffects.UNCLEAN_BODY.get())) {
				int effectLevel = entity.getEffect(JVPillageMobEffects.UNCLEAN_BODY.get()).getAmplifier() + 1;
...
//	}
	...
	public static void LastDitch(LivingHurtEvent event) {
		...
		if (damageSource == null || entity == null || damageSource.getEntity() == null)
			return;
		if (!entity.level().isClientSide()) {
			if (entity.hasEffect(JVPillageMobEffects.LAST_DITCH.get())) {
				int effectLevel = entity.getEffect(JVPillageMobEffects.LAST_DITCH.get()).getAmplifier() + 1;
	...
	public static void Fairness(LivingAttackEvent event) {
		...
		if (damageSource == null || entity == null)
			return;
		if (!entity.level().isClientSide()) {
			if (entity.hasEffect(JVPillageMobEffects.FAIRNESS.get())) {
				int effectLevel = entity.getEffect(JVPillageMobEffects.FAIRNESS.get()).getAmplifier() + 1;
