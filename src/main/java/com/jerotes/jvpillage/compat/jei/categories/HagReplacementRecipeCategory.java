package com.jerotes.jvpillage.compat.jei.categories;
...
public class HagReplacementRecipeCategory implements IRecipeCategory<HagReplacementRecipe> {
	public static final RecipeType<HagReplacementRecipe> HAG_REPLACEMENT = RecipeType.create(JVPillage.MODID, "hag_replacement", HagReplacementRecipe.class);
	...
	public HagReplacementRecipeCategory(IGuiHelper helper) {
		title = Component.translatable("gui.jvpillage.hag_replacement");
		ResourceLocation backgroundImage =
				new ResourceLocation(JVPillage.MODID, "textures/gui/container/hag_replacement.png");
		icon = helper.createDrawableIngredient(VanillaTypes.ITEM_STACK, new ItemStack(JVPillageItems.NEW_HAGS_CAULDRON.get()));
