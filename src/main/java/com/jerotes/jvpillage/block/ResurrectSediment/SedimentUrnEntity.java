...
public class SedimentUrnEntity extends RandomizableContainerBlockEntity {
    ...
    private final ContainerOpenersCounter openersCounter = new ContainerOpenersCounter(){
        ...
        protected void onOpen(Level level, BlockPos blockPos, BlockState blockState) {
            SedimentUrnEntity.this.playSound(blockPos, JVPillageSoundEvents.SEDIMENT_URN_OPEN);
            SedimentUrnEntity.this.updateBlockState(blockState, true);
        }

        @Override
        protected void onClose(Level level, BlockPos blockPos, BlockState blockState) {
            SedimentUrnEntity.this.playSound(blockPos, JVPillageSoundEvents.SEDIMENT_URN_CLOSE);
    ...
    public SedimentUrnEntity(BlockPos blockPos, BlockState blockState) {
        super(JVPillageBlockEntityType.SEDIMENT_URN.get(), blockPos, blockState);
    }
    ...
    protected Component getDefaultName() {
        return Component.translatable("block.jvpillage.sediment_urn");
    }
