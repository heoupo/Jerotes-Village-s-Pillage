...
public class JVPillageItems implements JerotesItemsAdd {
	...
	public static final RegistryObject<Item> CHAMPION_EXPLORER_SPAWN_EGG = REGISTRY.register("champion_explorer_spawn_egg", () -> new ChampionSpawnEgg(JVPillageEntityType.EXPLORER));
	...
	public static final RegistryObject<Item> CHAMPION_TRUMPETER_SPAWN_EGG = REGISTRY.register("champion_trumpeter_spawn_egg", () -> new ChampionSpawnEgg(JVPillageEntityType.TRUMPETER));
	...
	public static final RegistryObject<Item> CHAMPION_JAVELIN_THROWER_SPAWN_EGG = REGISTRY.register("champion_javelin_thrower_spawn_egg", () -> new ChampionSpawnEgg(JVPillageEntityType.JAVELIN_THROWER));
	...
	public static final RegistryObject<Item> CHAMPION_BITTER_COLD_SORCERER_SPAWN_EGG = REGISTRY.register("champion_bitter_cold_sorcerer_spawn_egg", () -> new ChampionSpawnEgg(JVPillageEntityType.BITTER_COLD_SORCERER));
	...
	public static final RegistryObject<Item> CHAMPION_WILD_FINDER_SPAWN_EGG = REGISTRY.register("champion_wild_finder_spawn_egg", () -> new ChampionSpawnEgg(JVPillageEntityType.WILD_FINDER));
	...
	public static final RegistryObject<Item> CHAMPION_LAMP_WIZARD_SPAWN_EGG = REGISTRY.register("champion_lamp_wizard_spawn_egg", () -> new ChampionSpawnEgg(JVPillageEntityType.LAMP_WIZARD));
	...
	public static final RegistryObject<Item> CHAMPION_SLAVERY_SUPERVISOR_SPAWN_EGG = REGISTRY.register("champion_slavery_supervisor_spawn_egg", () -> new ChampionEliteSpawnEgg(JVPillageEntityType.SLAVERY_SUPERVISOR));
	...
	public static final RegistryObject<Item> CHAMPION_FIREPOWER_POURER_SPAWN_EGG = REGISTRY.register("champion_firepower_pourer_spawn_egg", () -> new ChampionEliteSpawnEgg(JVPillageEntityType.FIREPOWER_POURER));
	...
	public static final RegistryObject<Item> CHAMPION_NECROMANCY_WARLOCK_SPAWN_EGG = REGISTRY.register("champion_necromancy_warlock_spawn_egg", () -> new ChampionEliteSpawnEgg(JVPillageEntityType.NECROMANCY_WARLOCK));
	...
	public static final RegistryObject<Item> CHAMPION_GAVILER_SPAWN_EGG = REGISTRY.register("champion_gaviler_spawn_egg", () -> new ChampionEliteSpawnEgg(JVPillageEntityType.GAVILER));
	...
	public static final RegistryObject<Item> CHAMPION_AX_CRAZY_SPAWN_EGG = REGISTRY.register("champion_ax_crazy_spawn_egg", () -> new ChampionEliteSpawnEgg(JVPillageEntityType.AX_CRAZY));
	...
	public static final RegistryObject<Item> CHAMPION_ADVENTURER_SPAWN_EGG = REGISTRY.register("champion_adventurer_spawn_egg", () -> new ChampionEliteSpawnEgg(JVPillageEntityType.ADVENTURER));
	...
	public static final RegistryObject<Item> CHAMPION_GIANT_MONSTER_SPAWN_EGG = REGISTRY.register("champion_giant_monster_spawn_egg", () -> new ChampionSpawnEgg(JVPillageEntityType.GIANT_MONSTER));
	...
	public static final RegistryObject<Item> FAKE_MALIALOSAUR_SPAWN_EGG = REGISTRY.register("fake_malialosaur_spawn_egg", () -> new ForgeSpawnEggItem(JVPillageEntityType.FAKE_MALIALOSAUR, 0xffffff, 0xffffff, new Item.Properties()));
	...
	public static final RegistryObject<Item> SLIDER_AX_CRAZY_SPAWN_EGG = REGISTRY.register("slider_ax_crazy_spawn_egg", () -> new ForgeSpawnEggItem(JVPillageEntityType.SLIDER_AX_CRAZY, 0xffffff, 0xffffff, new Item.Properties().rarity(Rarity.RARE)));
	public static final RegistryObject<Item> FURY_SLIDER_AX_CRAZY_SPAWN_EGG = REGISTRY.register("fury_slider_ax_crazy_spawn_egg", () -> new ForgeSpawnEggItem(JVPillageEntityType.FURY_SLIDER_AX_CRAZY, 0xffffff, 0xffffff, new Item.Properties().rarity(Rarity.RARE)));
	...
	//虚洞
	public static final RegistryObject<Item> SLIDER_BLOCK = block(JVPillageBlocks.SLIDER_BLOCK);
	public static final RegistryObject<Item> SLIDER_MARK = block(JVPillageBlocks.SLIDER_MARK);
	public static final RegistryObject<Item> SLIDER_MUCUS = REGISTRY.register("slider_mucus", () ->  new ItemDesc(new Item.Properties().stacksTo(64).rarity(Rarity.COMMON).food(JVPillageFoods.SLIDER_MUCUS), 1));
