...
public class JVPillagePotions {
    public static final DeferredRegister<Potion> REGISTRY = DeferredRegister.create(ForgeRegistries.POTIONS, JVPillage.MODID);
    ...
    public static final RegistryObject<Potion> WITCH_ROT = REGISTRY.register("witch_rot", () -> new Potion(
            ...
            new MobEffectInstance(JVPillageMobEffects.FRAGRANCE.get(), 12 * 20, 1)
    ));
    ...
    public static final RegistryObject<Potion> LAST_STAND = REGISTRY.register("last_stand", () -> new Potion(
            new MobEffectInstance(JVPillageMobEffects.LAST_DITCH.get(), 120 * 20, 0)
    ));
    ...
    public static final RegistryObject<Potion> HAUNTING_IMP = REGISTRY.register("haunting_imp", () -> new Potion(
            ...
            new MobEffectInstance(JVPillageMobEffects.RAMPANT.get(), 120 * 20, 0)
    ));
    ...
    public static final RegistryObject<Potion> DESPICABLE_MEROR = REGISTRY.register("despicable_meror", () -> new Potion(
            new MobEffectInstance(JVPillageMobEffects.MEROR_STIMULIN.get(), 24 * 20, 1),
            new MobEffectInstance(JVPillageMobEffects.WILDERNESS_GIANT_POISON.get(), 24 * 20, 0)
    ));
    public static final RegistryObject<Potion> SEA_MONSTER_WORSHIP = REGISTRY.register("sea_monster_worship", () -> new Potion(
            new MobEffectInstance(JVPillageMobEffects.MALIGNASAUR_ASPHYXIA.get(), 24 * 20, 0),
            new MobEffectInstance(JVPillageMobEffects.OCEAN_DRAGON_DETERRENCE.get(), 24 * 20, 0)
    ));
    ...
    public static final RegistryObject<Potion> BINDING_PACT = REGISTRY.register("binding_pact", () -> new Potion(
            new MobEffectInstance(JVPillageMobEffects.FAIRNESS.get(), 5 * 20, 0)
    ));
}
