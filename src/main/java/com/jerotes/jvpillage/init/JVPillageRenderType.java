...
@OnlyIn(Dist.CLIENT)
public class JVPillageRenderType extends JerotesRenderType {
	public JVPillageRenderType(String p_173178_, VertexFormat p_173179_, VertexFormat.Mode p_173180_, int p_173181_, boolean p_173182_, boolean p_173183_, Runnable p_173184_, Runnable p_173185_) {
	...
	public static RenderType meror_rete() {
		return create("meror_rete",
				...
				RenderType.CompositeState.builder()
						...
						.setTextureState(new TextureStateShard(new ResourceLocation(JVPillage.MODID, "textures/entity/meror_rete_add.png"), true, false))
	...
	private static final RenderType BEAST_TOUGH_GLINT_CORROSIVER = create("tough_glint_corrosiver",
			...
			CompositeState.builder()
					.setShaderState(RENDERTYPE_GLINT_SHADER)
					.setTextureState(new TextureStateShard(new ResourceLocation(JVPillage.MODID, "textures/entity/tough_glint_corrosiver.png"), true, false))
					.setWriteMaskState(COLOR_WRITE)
					.setCullState(NO_CULL)
	...
	private static final RenderType BEAST_TOUGH_GLINT_GEMSTONE_MALIGNASAUR = create("tough_glint_gemstone_malignasaur",
			...
			CompositeState.builder()
					.setShaderState(RENDERTYPE_GLINT_SHADER)
					.setTextureState(new TextureStateShard(new ResourceLocation(JVPillage.MODID, "textures/entity/tough_glint_gemstone_malignasaur.png"), true, false))
					.setWriteMaskState(COLOR_WRITE)
					.setCullState(NO_CULL)
					.setDepthTestState(EQUAL_DEPTH_TEST)
					.setTransparencyState(GLINT_TRANSPARENCY)
	...
	private static final RenderType BEAST_TOUGH_GLINT_BRIGHT_LAND_BEAST = create("tough_glint_bright_land_beast",
			...
			CompositeState.builder()
					.setShaderState(RENDERTYPE_GLINT_SHADER)
					.setTextureState(new TextureStateShard(new ResourceLocation(JVPillage.MODID, "textures/entity/tough_glint_bright_land_beast.png"), true, false))
					.setWriteMaskState(COLOR_WRITE)
					.setCullState(NO_CULL)
					.setDepthTestState(EQUAL_DEPTH_TEST)
					.setTransparencyState(GLINT_TRANSPARENCY)
	...
	private static final RenderType BEAST_TOUGH_GLINT_PROSPEROUS_ENVOY = create("tough_glint_prosperous_envoy",
			...
			CompositeState.builder()
					.setShaderState(RENDERTYPE_GLINT_SHADER)
					.setTextureState(new TextureStateShard(new ResourceLocation(JVPillage.MODID, "textures/entity/tough_glint_prosperous_envoy.png"), true, false))
					.setWriteMaskState(COLOR_WRITE)
					.setCullState(NO_CULL)
					.setDepthTestState(EQUAL_DEPTH_TEST)
					.setTransparencyState(GLINT_TRANSPARENCY)
