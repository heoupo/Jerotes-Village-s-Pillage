...
public class JVPillageSoundEvents {
    ...
    public static final SoundEvent SLIDER_AMBIENT = createSoundEvent("slider_ambient");
    ...
    public static final SoundEvent MAGIC_COHESION_SLIDE_AXE = createSoundEvent("magic_cohesion_slide_axe");
    ...
    private static SoundEvent createSoundEvent(final String soundName) {
        final ResourceLocation soundID = new ResourceLocation(JVPillage.MODID, soundName);
    ...
    public static void registerSoundEvents(final NewRegistryEvent event) {
        try {
            for (Field f : JVPillageSoundEvents.class.getFields()) {
