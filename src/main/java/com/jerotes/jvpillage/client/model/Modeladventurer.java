...
import com.jerotes.jvpillage.client.animation.AdventurerAnimation;
...
public class Modeladventurer<T extends AdventurerEntity> extends Modelillager<T> {
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(JVPillage.MODID, "adventurer"), "main");
	...
	public void setupAnim(T t, float f, float f2, float f3, float f4, float f5) {
		...
		if (t.getItemBySlot(EquipmentSlot.HEAD).getItem() != JVPillageItems.ADVENTURER_HELMET.get()) {
			this.hat_armor.visible = false;
		}
		else {
			this.hat_armor.visible = true;
		}
		if (t.getItemBySlot(EquipmentSlot.CHEST).getItem() != JVPillageItems.ADVENTURER_CHESTPLATE.get()) {
		...
		if (t.getItemBySlot(EquipmentSlot.LEGS).getItem() != JVPillageItems.ADVENTURER_LEGGINGS.get()) {
		...
		if (t.getItemBySlot(EquipmentSlot.FEET).getItem() != JVPillageItems.ADVENTURER_BOOTS.get()) {
