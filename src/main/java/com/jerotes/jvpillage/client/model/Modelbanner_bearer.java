...
import com.jerotes.jvpillage.client.animation.BannerBearerAnimation;
...
public class Modelbanner_bearer<T extends BannerBearerEntity> extends Modelillager<T> {
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(JVPillage.MODID, "banner_bearer"), "main");
