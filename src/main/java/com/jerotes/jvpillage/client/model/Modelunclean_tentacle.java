...
import com.jerotes.jvpillage.client.animation.UncleanTentacleAnimation;
...
public class Modelunclean_tentacle<T extends UncleanTentacleEntity> extends HierarchicalModel<T> {
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(JVPillage.MODID, "unclean_tentacle"), "main");
