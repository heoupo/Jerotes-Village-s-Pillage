...
import com.jerotes.jvpillage.client.animation.CyclonerAnimation;
...
public class Modelcycloner<T extends CyclonerEntity> extends Modelillager<T> {
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(JVPillage.MODID, "cycloner"), "main");
