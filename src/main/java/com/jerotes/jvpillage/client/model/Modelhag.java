...
import com.jerotes.jvpillage.client.animation.HagAnimation;
import com.jerotes.jvpillage.client.animation.LampWizardAnimation;
...
public class Modelhag<T extends LivingEntity> extends Modelspecial_action<T> {
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(JVPillage.MODID, "hag"), "main");
