...
import com.jerotes.jvpillage.client.animation.ExecutionerAnimation;
...
public class Modelexecutioner<T extends ExecutionerEntity> extends Modelillager<T> {
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(JVPillage.MODID, "executioner"), "main");
