...
import com.jerotes.jvpillage.client.animation.NecromancyWarlockAnimation;
...
public class Modelnecromancy_warlock<T extends NecromancyWarlockEntity> extends Modelillager<T> {
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(JVPillage.MODID, "necromancy_warlock"), "main");
