...
public class Modelslavery_supervisor<T extends SlaverySupervisorEntity> extends Modelillager<T> {
	...
	public void setupAnim(T t, float f, float f2, float f3, float f4, float f5) {
		...
		if (t.getItemBySlot(EquipmentSlot.HEAD).getItem() != JVPillageItems.SLAVERY_SUPERVISOR_HELMET.get()) {
			this.hat_armor.visible = false;
		}
		else {
			this.hat_armor.visible = true;
		}
		if (t.getItemBySlot(EquipmentSlot.CHEST).getItem() != JVPillageItems.SLAVERY_SUPERVISOR_CHESTPLATE.get()) {
		...
		if (t.getItemBySlot(EquipmentSlot.LEGS).getItem() != JVPillageItems.SLAVERY_SUPERVISOR_LEGGINGS.get()) {
		...
		if (t.getItemBySlot(EquipmentSlot.FEET).getItem() != JVPillageItems.SLAVERY_SUPERVISOR_BOOTS.get()) {
