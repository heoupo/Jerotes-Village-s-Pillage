...
import com.jerotes.jvpillage.entity.Monster.IllagerFaction.FurySliderAxCrazyEntity;
...
public class Modelfury_slider_ax_crazy<T extends FurySliderAxCrazyEntity> extends Modelillagerlike_raider<T> {
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(JVPillage.MODID, "fury_slider_ax_crazy"), "main");
	private final ModelPart head;
	private final ModelPart arms;

	public Modelfury_slider_ax_crazy(ModelPart root) {
		super(root);
	...
	public void setupAnim(T t, float f, float f2, float f3, float f4, float f5) {
		...
		else if (!t.getMainHandItem().isEmpty() ) {
		...
		boolean flag = abstractillager$illagerarmpose == IllagerLikeRaiderEntity.IllagerArmPose.CROSSED && !(t instanceof AlwaysShowArmIllagerEntity);
