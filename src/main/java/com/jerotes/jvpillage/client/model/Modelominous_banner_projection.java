...
import com.jerotes.jvpillage.client.animation.OminousBannerProjectionAnimation;
...
public class Modelominous_banner_projection<T extends LivingEntity> extends HierarchicalModel<T> {
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(JVPillage.MODID, "ominous_banner_projection"), "main");
