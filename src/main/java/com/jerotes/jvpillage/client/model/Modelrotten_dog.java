...
import com.jerotes.jvpillage.client.animation.RottenDogAnimation;
...
public class Modelrotten_dog<T extends RottenDogEntity> extends AgeableHierarchicalModel<T> {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(JVPillage.MODID, "rotten_dog"), "main");
