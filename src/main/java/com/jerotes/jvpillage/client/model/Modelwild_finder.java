...
import com.jerotes.jvpillage.client.animation.WildFinderAnimation;
...
public class Modelwild_finder<T extends WildFinderEntity> extends Modelillager<T> {
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(JVPillage.MODID, "wild_finder"), "main");
