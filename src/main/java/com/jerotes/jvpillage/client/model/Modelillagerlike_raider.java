...
import com.jerotes.jvpillage.entity.Monster.IllagerFaction.IllagerLikeRaiderEntity;
...
public class Modelillagerlike_raider<T extends IllagerLikeRaiderEntity> extends Modelspecial_action<T> {
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(JVPillage.MODID, "illagerlike_raider"), "main");
