...
import com.jerotes.jvpillage.client.animation.FireSpitterAnimation;
import com.jerotes.jvpillage.entity.Interface.AlwaysShowArmIllagerEntity;
import com.jerotes.jvpillage.entity.Monster.IllagerFaction.FireSpitterEntity;
...
public class Modelfire_spitter<T extends FireSpitterEntity> extends Modelillager<T> {
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(JVPillage.MODID, "fire_spitter"), "main");
