...
import com.jerotes.jvpillage.client.animation.GiantMonsterAnimation;
...
public class Modelgiant_monster<T extends GiantMonsterEntity> extends AgeableHierarchicalModel<T> {
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(JVPillage.MODID, "giant_monster"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition head = partdefinition.addOrReplaceChild("head", CubeListBuilder.create().texOffs(0, 0).addBox(-8.0F, -7.5F, -9.0F, 16.0F, 15.0F, 12.0F, new CubeDeformation(0.5F))
				.texOffs(116, 30).addBox(-8.0F, 6.5F, -9.0F, 16.0F, -1.0F, 12.0F, new CubeDeformation(0.5F)), PartPose.offset(0.0F, -2.5F, -17.0F));
		...
		PartDefinition right_horn_r2 = right_horn.addOrReplaceChild("right_horn_r2", CubeListBuilder.create().texOffs(0, 42).addBox(-1.0F, -11.9379F, 0.5357F, 2.0F, 13.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 11.2004F, -5.9523F, 0.9599F, 0.0F, 0.0F));
		...
		PartDefinition left_horn_r2 = left_horn.addOrReplaceChild("left_horn_r2", CubeListBuilder.create().texOffs(0, 42).mirror().addBox(-1.0F, -6.5F, -2.0F, 2.0F, 13.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.0F, 6.0042F, -8.9523F, 0.9599F, 0.0F, 0.0F));
		...
		PartDefinition main_chain_r3 = chain.addOrReplaceChild("main_chain_r3", CubeListBuilder.create().texOffs(137, 0).addBox(-8.0F, 0.0F, -1.5F, 16.0F, 0.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 4.058F, 5.8415F, 0.9599F, 0.0F, 0.0F));

		PartDefinition main_chain_r4 = chain.addOrReplaceChild("main_chain_r4", CubeListBuilder.create().texOffs(137, 3).addBox(-8.0F, 0.0F, -1.5F, 16.0F, 0.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 4.058F, 5.8415F, 2.5307F, 0.0F, 0.0F));
		...
		PartDefinition jaw = head.addOrReplaceChild("jaw", CubeListBuilder.create().texOffs(0, 27).addBox(-8.0F, -0.5F, -11.0F, 16.0F, 3.0F, 12.0F, new CubeDeformation(0.0F))
				.texOffs(116, 42).addBox(-8.0F, 0.5F, -11.0F, 16.0F, 0.0F, 12.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 8.0F, 2.0F));
		...
		PartDefinition tail_r1 = tail.addOrReplaceChild("tail_r1", CubeListBuilder.create().texOffs(0, 59).addBox(-2.0F, -9.2705F, -6.8221F, 4.0F, 13.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 8.5F, -4.0F, -1.0908F, 0.0F, 0.0F));
		...
		PartDefinition right_hind_foot = right_hind_leg.addOrReplaceChild("right_hind_foot", CubeListBuilder.create().texOffs(94, 31).addBox(-4.0F, -1.0F, -4.0F, 8.0F, 16.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offset(-1.0F, 17.0F, -0.5F));
		...
		PartDefinition left_hind_foot = left_hind_leg.addOrReplaceChild("left_hind_foot", CubeListBuilder.create().texOffs(94, 31).mirror().addBox(-4.0F, -1.0F, -4.0F, 8.0F, 16.0F, 8.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(1.0F, 17.0F, -0.5F));
		...
		PartDefinition right_front_foot = right_front_leg.addOrReplaceChild("right_front_foot", CubeListBuilder.create().texOffs(56, 36).addBox(-4.0F, -1.5F, -5.5F, 8.0F, 17.0F, 11.0F, new CubeDeformation(0.0F)), PartPose.offset(-1.0F, 17.0F, 0.0F));
		...
		PartDefinition left_front_foot = left_front_leg.addOrReplaceChild("left_front_foot", CubeListBuilder.create().texOffs(56, 36).mirror().addBox(-4.0F, -1.5F, -5.5F, 8.0F, 17.0F, 11.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(1.0F, 17.0F, 0.0F));
	...
	public void setupAnim(T t, float f, float f2, float f3, float f4, float f5) {
		...
		if (t.isVehicle() && t.getControllingPassenger() == t.getOwner()) {
			this.animateWalk(GiantMonsterAnimation.RUN, f, f2, 2.0f, 2.0f);
		}
		else {
		...
		this.animate(((GiantMonsterEntity)t).attackAnimationState, GiantMonsterAnimation.ATTACK, f3);
