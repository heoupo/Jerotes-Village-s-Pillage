...
public class SkinEntityBodyLayer<T extends LivingEntity, M extends EntityModel<T>> extends RenderLayer<T, M> {
    ...
    public void render(PoseStack poseStack, MultiBufferSource multiBufferSource, int n, T t, float f, float f2, float f3, float f4, float f5, float f6) {
        ...
        //皮肤
        ResourceLocation bodyLocation = new ResourceLocation(JVPillage.MODID, "textures/entity/skin/" + this.string + "/" + sexual + "/base.png");
        //眼睛
        ResourceLocation eyeBaseLocation = new ResourceLocation(JVPillage.MODID, "textures/entity/skin/" + this.string + "/" + sexual + "/eye_base.png");
        ResourceLocation leftEyeLocation = new ResourceLocation(JVPillage.MODID, "textures/entity/skin/" + this.string + "/" + sexual + "/eye/eye_left.png");
        ResourceLocation rightEyeLocation = new ResourceLocation(JVPillage.MODID, "textures/entity/skin/" + this.string + "/" + sexual + "/eye/eye_right.png");
        //头发
        ResourceLocation hairLocation = new ResourceLocation(JVPillage.MODID, "textures/entity/skin/" + this.string + "/" + sexual + "/hair/hair_" + ((SkinEntity)t).HairType() + ".png");
        if (t.isBaby()) {
            hairLocation = new ResourceLocation(JVPillage.MODID, "textures/entity/skin/" + this.string + "/" + sexual + "/baby_hair/hair_" + ((SkinEntity)t).HairType() + ".png");
        }
        //附件
        ResourceLocation addLocation_1 = new ResourceLocation(JVPillage.MODID, "textures/entity/skin/" + this.string + "/" + sexual + "/add/add_" + ((SkinEntity)t).AddType_1() + ".png");
        ResourceLocation addBaseLocation_1 = new ResourceLocation(JVPillage.MODID, "textures/entity/skin/" + this.string + "/" + sexual + "/add/add_base_" + ((SkinEntity)t).AddType_1() + ".png");
        ResourceLocation addLocation_2 = new ResourceLocation(JVPillage.MODID, "textures/entity/skin/" + this.string + "/" + sexual + "/add/add_" + ((SkinEntity)t).AddType_2() + ".png");
        ResourceLocation addBaseLocation_2 = new ResourceLocation(JVPillage.MODID, "textures/entity/skin/" + this.string + "/" + sexual + "/add/add_base_" + ((SkinEntity)t).AddType_2() + ".png");
        ResourceLocation addLocation_3 = new ResourceLocation(JVPillage.MODID, "textures/entity/skin/" + this.string + "/" + sexual + "/add/add_" + ((SkinEntity)t).AddType_3() + ".png");
        ResourceLocation addBaseLocation_3 = new ResourceLocation(JVPillage.MODID, "textures/entity/skin/" + this.string + "/" + sexual + "/add/add_base_" + ((SkinEntity)t).AddType_3() + ".png");
        //上衣
        ResourceLocation jacketLocation = new ResourceLocation(JVPillage.MODID, "textures/entity/skin/" + this.string + "/" + sexual + "/clothes/jacket_" + ((SkinEntity)t).JacketType() + ".png");
        ResourceLocation jacketBaseLocation = new ResourceLocation(JVPillage.MODID, "textures/entity/skin/" + this.string + "/" + sexual + "/clothes/jacket_base_" + ((SkinEntity)t).JacketType() + ".png");
        //裤子
        ResourceLocation pantsLocation = new ResourceLocation(JVPillage.MODID, "textures/entity/skin/" + this.string + "/" + sexual + "/clothes/pants_" + ((SkinEntity)t).PantsType() + ".png");
        ResourceLocation pantsBaseLocation = new ResourceLocation(JVPillage.MODID, "textures/entity/skin/" + this.string + "/" + sexual + "/clothes/pants_base_" + ((SkinEntity)t).PantsType() + ".png");
        //手套
        ResourceLocation glovesLocation = new ResourceLocation(JVPillage.MODID, "textures/entity/skin/" + this.string + "/" + sexual + "/clothes/gloves_" + ((SkinEntity)t).GlovesType() + ".png");
        ResourceLocation glovesBaseLocation = new ResourceLocation(JVPillage.MODID, "textures/entity/skin/" + this.string + "/" + sexual + "/clothes/gloves_base_" + ((SkinEntity)t).GlovesType() + ".png");
        //饰品
        ResourceLocation baubleLocation_1 = new ResourceLocation(JVPillage.MODID, "textures/entity/skin/" + this.string + "/" + sexual + "/bauble/bauble_" + ((SkinEntity)t).BaubleType_1() + ".png");
        ResourceLocation baubleBaseLocation_1 = new ResourceLocation(JVPillage.MODID, "textures/entity/skin/" + this.string + "/" + sexual + "/bauble/bauble_base_" + ((SkinEntity)t).BaubleType_1() + ".png");
        ResourceLocation baubleLocation_2 = new ResourceLocation(JVPillage.MODID, "textures/entity/skin/" + this.string + "/" + sexual + "/bauble/bauble_" + ((SkinEntity)t).BaubleType_2() + ".png");
        ResourceLocation baubleBaseLocation_2 = new ResourceLocation(JVPillage.MODID, "textures/entity/skin/" + this.string + "/" + sexual + "/bauble/bauble_base_" + ((SkinEntity)t).BaubleType_2() + ".png");
        ResourceLocation baubleLocation_3 = new ResourceLocation(JVPillage.MODID, "textures/entity/skin/" + this.string + "/" + sexual + "/bauble/bauble_" + ((SkinEntity)t).BaubleType_3() + ".png");
        ResourceLocation baubleBaseLocation_3 = new ResourceLocation(JVPillage.MODID, "textures/entity/skin/" + this.string + "/" + sexual + "/bauble/bauble_base_" + ((SkinEntity)t).BaubleType_3() + ".png");
        //鞋子
        ResourceLocation shoesLocation = new ResourceLocation(JVPillage.MODID, "textures/entity/skin/" + this.string + "/" + sexual + "/clothes/shoes_" + ((SkinEntity)t).ShoesType() + ".png");
        ResourceLocation shoesBaseLocation = new ResourceLocation(JVPillage.MODID, "textures/entity/skin/" + this.string + "/" + sexual + "/clothes/shoes_base_" + ((SkinEntity)t).ShoesType() + ".png");
        //帽子
        ResourceLocation hatLocation = new ResourceLocation(JVPillage.MODID, "textures/entity/skin/" + this.string + "/" + sexual + "/clothes/hat_" + ((SkinEntity)t).HatType() + ".png");
        ResourceLocation hatBaseLocation = new ResourceLocation(JVPillage.MODID, "textures/entity/skin/" + this.string + "/" + sexual + "/clothes/hat_base_" + ((SkinEntity)t).HatType() + ".png");
        //外套
        ResourceLocation overcoatLocation = new ResourceLocation(JVPillage.MODID, "textures/entity/skin/" + this.string + "/" + sexual + "/clothes/overcoat_" + ((SkinEntity)t).OvercoatType() + ".png");
        ResourceLocation overcoatBaseLocation = new ResourceLocation(JVPillage.MODID, "textures/entity/skin/" + this.string + "/" + sexual + "/clothes/overcoat_base_" + ((SkinEntity)t).OvercoatType() + ".png");
