...
public class OminousBannerProjectionGlowOtherBodyLayer<T extends LivingEntity, M extends EntityModel<T>> extends RenderLayer<T, M> {
    ...
    private static final ResourceLocation LEGENDARY_LOCATION = new ResourceLocation(JVPillage.MODID, "textures/entity/ominous_banner_projection_banner_legendary_by_illager_wither.png");
