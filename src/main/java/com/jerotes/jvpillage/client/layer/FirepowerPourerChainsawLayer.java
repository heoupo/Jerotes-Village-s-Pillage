...
public class FirepowerPourerChainsawLayer<T extends FirepowerPourerEntity, M extends EntityModel<T>> extends RenderLayer<T, M> {
    private static final ResourceLocation CHAINSAW_0_LOCATION = new ResourceLocation(JVPillage.MODID, "textures/entity/firepower_pourer_chainsaw_0.png");
    private static final ResourceLocation CHAINSAW_1_LOCATION = new ResourceLocation(JVPillage.MODID, "textures/entity/firepower_pourer_chainsaw_1.png");
    private static final ResourceLocation CHAINSAW_2_LOCATION = new ResourceLocation(JVPillage.MODID, "textures/entity/firepower_pourer_chainsaw_2.png");
    private static final ResourceLocation HELL_MARCHER_CHAINSAW_0_LOCATION = new ResourceLocation(JVPillage.MODID, "textures/entity/firepower_pourer_hell_marcher_chainsaw_0.png");
    private static final ResourceLocation HELL_MARCHER_CHAINSAW_1_LOCATION = new ResourceLocation(JVPillage.MODID, "textures/entity/firepower_pourer_hell_marcher_chainsaw_1.png");
    private static final ResourceLocation HELL_MARCHER_CHAINSAW_2_LOCATION = new ResourceLocation(JVPillage.MODID, "textures/entity/firepower_pourer_hell_marcher_chainsaw_2.png");
