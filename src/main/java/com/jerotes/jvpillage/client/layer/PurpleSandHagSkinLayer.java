...
public class PurpleSandHagSkinLayer<T extends LivingEntity, M extends EntityModel<T>> extends RenderLayer<T, M> {
    ...
    public void render(PoseStack poseStack, MultiBufferSource multiBufferSource, int n, T t, float f, float f2, float f3, float f4, float f5, float f6) {
        ...
        //皮肤
        ResourceLocation bodyLocation = new ResourceLocation(JVPillage.MODID, "textures/entity/skin/hag/female/base.png");
        //眼睛
        ResourceLocation eyeBaseLocation = new ResourceLocation(JVPillage.MODID, "textures/entity/skin/hag/female/eye_base.png");
        ResourceLocation leftEyeLocation = new ResourceLocation(JVPillage.MODID, "textures/entity/skin/hag/female/eye/eye_left.png");
        ResourceLocation rightEyeLocation = new ResourceLocation(JVPillage.MODID, "textures/entity/skin/hag/female/eye/eye_right.png");
        //头发
        ResourceLocation hairLocation = new ResourceLocation(JVPillage.MODID, "textures/entity/skin/hag/female/hair/hair_16.png");
        //附件
        ResourceLocation addLocation_1 = new ResourceLocation(JVPillage.MODID, "textures/entity/skin/hag/female/add/add_1.png");
        ResourceLocation addBaseLocation_1 = new ResourceLocation(JVPillage.MODID, "textures/entity/skin/hag/female/add/add_base_1.png");
        //上衣
        ResourceLocation jacketLocation = new ResourceLocation(JVPillage.MODID, "textures/entity/skin/hag/female/clothes/jacket_1.png");
        ResourceLocation jacketBaseLocation = new ResourceLocation(JVPillage.MODID, "textures/entity/skin/hag/female/clothes/jacket_base_1.png");
        //裤子
        ResourceLocation pantsLocation = new ResourceLocation(JVPillage.MODID, "textures/entity/skin/hag/female/clothes/pants_1.png");
        ResourceLocation pantsBaseLocation = new ResourceLocation(JVPillage.MODID, "textures/entity/skin/hag/female/clothes/pants_base_1.png");
        //鞋子
        ResourceLocation shoesLocation = new ResourceLocation(JVPillage.MODID, "textures/entity/skin/hag/female/clothes/shoes_1.png");
        ResourceLocation shoesBaseLocation = new ResourceLocation(JVPillage.MODID, "textures/entity/skin/hag/female/clothes/shoes_base_1.png");
        //帽子
        ResourceLocation hatLocation = new ResourceLocation(JVPillage.MODID, "textures/entity/skin/hag/female/clothes/hat_11.png");
        ResourceLocation hatBaseLocation = new ResourceLocation(JVPillage.MODID, "textures/entity/skin/hag/female/clothes/hat_base_11.png");
        //外套
        ResourceLocation overcoatLocation = new ResourceLocation(JVPillage.MODID, "textures/entity/skin/hag/female/clothes/overcoat_3.png");
        ResourceLocation overcoatBaseLocation = new ResourceLocation(JVPillage.MODID, "textures/entity/skin/hag/female/clothes/overcoat_base_3.png");
