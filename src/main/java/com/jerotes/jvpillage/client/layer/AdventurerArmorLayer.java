...
public class AdventurerArmorLayer<T extends AdventurerEntity, M extends EntityModel<T>> extends RenderLayer<T, M> {
    ...
    private static final ResourceLocation EX1_ARMOR_LOCATION = new ResourceLocation(JVPillage.MODID, "textures/entity/illager/adventurer/adventurer_armor_ex1_by_heoupo.png");
    private static final ResourceLocation EX2_ARMOR_LOCATION = new ResourceLocation(JVPillage.MODID, "textures/entity/illager/adventurer/adventurer_armor_ex2_by_heoupo.png");
    private static final ResourceLocation COMMANDER_ARMOR_LOCATION = new ResourceLocation(JVPillage.MODID, "textures/entity/illager/adventurer/commander_armor.png");
