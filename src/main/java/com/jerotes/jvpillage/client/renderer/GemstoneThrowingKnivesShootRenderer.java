...
import com.jerotes.jvpillage.client.model.Modelgemstone_throwing_knives;
...
public class GemstoneThrowingKnivesShootRenderer extends EntityRenderer<GemstoneThrowingKnivesShootEntity> {
    ...
    public static final ResourceLocation SPECTRAL_ARROW_LOCATION = new ResourceLocation(JVPillage.MODID, "textures/entity/gemstone_throwing_knives_shoot_model.png");
