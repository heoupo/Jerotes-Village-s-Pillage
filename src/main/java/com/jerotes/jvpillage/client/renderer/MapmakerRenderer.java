...
import com.jerotes.jvpillage.entity.Monster.IllagerFaction.MapmakerEntity;
...
public class MapmakerRenderer extends HumanoidMobRenderer<MapmakerEntity, Modelillager<MapmakerEntity>> {
    private static final ResourceLocation LOCATION = new ResourceLocation(JVPillage.MODID, "textures/entity/mapmaker.png");
