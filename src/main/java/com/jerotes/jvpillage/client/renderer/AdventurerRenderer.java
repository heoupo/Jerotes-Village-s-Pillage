...
import com.jerotes.jvpillage.client.layer.AdventurerArmorLayer;
import com.jerotes.jvpillage.client.layer.SedimentItemInHandLayer;
import com.jerotes.jvpillage.client.model.Modeladventurer;
import com.jerotes.jvpillage.config.OtherMainConfig;
import com.jerotes.jvpillage.entity.Monster.IllagerFaction.AdventurerEntity;
...
public class AdventurerRenderer extends MobRenderer<AdventurerEntity, Modeladventurer<AdventurerEntity>> {
    private static final ResourceLocation LOCATION = new ResourceLocation(JVPillage.MODID, "textures/entity/illager/adventurer/adventurer.png");
    private static final ResourceLocation EX_LOCATION = new ResourceLocation(JVPillage.MODID, "textures/entity/illager/adventurer/adventurer_ex_by_heoupo.png");
    private static final ResourceLocation COMMANDER_LOCATION = new ResourceLocation(JVPillage.MODID, "textures/entity/illager/adventurer/commander.png");
    private static final ResourceLocation ARMOR_LOCATION = new ResourceLocation(JVPillage.MODID, "textures/entity/illager/adventurer/adventurer_armor.png");
    ...
    public ResourceLocation getTextureLocation(AdventurerEntity entity) {
        if (WeatherEvent.isAprilFoolsDay() && OtherMainConfig.SpecialDay) {
            return new ResourceLocation(JVPillage.MODID, "textures/entity/illager/adventurer/ax_crazy_fake.png");
        }
        String string = ChatFormatting.stripFormatting(entity.getName().getString());
        if ("Commander".equals(string) || "指挥官".equals(string)) {
