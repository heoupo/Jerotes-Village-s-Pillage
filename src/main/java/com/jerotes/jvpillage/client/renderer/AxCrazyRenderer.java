...
import com.jerotes.jvpillage.client.model.Modelax_crazy;
...
public class AxCrazyRenderer extends HumanoidMobRenderer<AxCrazyEntity, Modelax_crazy<AxCrazyEntity>> {
    private static final ResourceLocation LOCATION = new ResourceLocation(JVPillage.MODID, "textures/entity/ax_crazy.png");
    private static final ResourceLocation BATEMAN_LOCATION = new ResourceLocation(JVPillage.MODID, "textures/entity/ax_crazy_bateman.png");
    private static final ResourceLocation ILLAGER_WITHER_LOCATION = new ResourceLocation(JVPillage.MODID, "textures/entity/ax_crazy_by_illager_wither.png");
    private static final ResourceLocation TWO_ILLAGER_WITHER_LOCATION = new ResourceLocation(JVPillage.MODID, "textures/entity/ax_crazy_noble_by_illager_wither.png");
