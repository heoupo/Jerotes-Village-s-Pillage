...
import com.jerotes.jvpillage.entity.Monster.IllagerFaction.ZombieKeeperEntity;
...
public class ZombieKeeperRenderer extends HumanoidMobRenderer<ZombieKeeperEntity, Modelillager<ZombieKeeperEntity>> {
    private static final ResourceLocation LOCATION = new ResourceLocation(JVPillage.MODID, "textures/entity/zombie_keeper.png");
