...
public class TrumpeterRenderer extends HumanoidMobRenderer<TrumpeterEntity, Modeltrumpeter<TrumpeterEntity>> {
    private static final ResourceLocation LOCATION = new ResourceLocation(JVPillage.MODID, "textures/entity/trumpeter.png");
    private static final ResourceLocation ILLAGER_WITHER_LOCATION = new ResourceLocation(JVPillage.MODID, "textures/entity/trumpeter_elite_by_illager_wither.png");
