...
import com.jerotes.jvpillage.client.model.Modeltrumpeter;
...
public class TrumpeterRenderer extends HumanoidMobRenderer<TrumpeterEntity, Modeltrumpeter<TrumpeterEntity>> {
    private static final ResourceLocation LOCATION = new ResourceLocation(JVPillage.MODID, "textures/entity/illager/trumpeter.png");
    private static final ResourceLocation ILLAGER_WITHER_LOCATION = new ResourceLocation(JVPillage.MODID, "textures/entity/illager/trumpeter_elite_by_illager_wither.png");
    ...
    @Override
    protected void scale(TrumpeterEntity entity, PoseStack poseStack, float f) {
        poseStack.scale(0.9375F, 0.9375F, 0.9375F);
        super.scale(entity, poseStack, f);
    }

    @Override
    public ResourceLocation getTextureLocation(TrumpeterEntity entity) {
