...
import com.jerotes.jvpillage.client.layer.RottenDogCollarLayer;
import com.jerotes.jvpillage.client.model.Modelrotten_dog;
...
public class RottenDogRenderer extends MobRenderer<RottenDogEntity, Modelrotten_dog<RottenDogEntity>> {
    private static final ResourceLocation WOLF_LOCATION = new ResourceLocation(JVPillage.MODID, "textures/entity/rotten_dog.png");
    private static final ResourceLocation WOLF_TAME_LOCATION = new ResourceLocation(JVPillage.MODID, "textures/entity/rotten_dog_tame.png");
    private static final ResourceLocation WOLF_ANGRY_LOCATION = new ResourceLocation(JVPillage.MODID, "textures/entity/rotten_dog_angry.png");
    private static final ResourceLocation WOLF_TAME_ANGRY_LOCATION = new ResourceLocation(JVPillage.MODID, "textures/entity/rotten_dog_tame_angry.png");
