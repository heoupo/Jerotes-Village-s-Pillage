...
import com.jerotes.jvpillage.client.model.Modelanimated_chain;
...
public class AnimatedChainRenderer extends MobRenderer<AnimatedChainEntity, Modelanimated_chain<AnimatedChainEntity>> {
    private static final ResourceLocation LOCATION = new ResourceLocation(JVPillage.MODID, "textures/entity/animated_chain.png");
