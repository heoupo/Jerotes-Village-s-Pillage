...
import com.jerotes.jvpillage.client.model.Modelfury_slider_ax_crazy;
...
public class FurySliderAxCrazyRenderer extends HumanoidMobRenderer<FurySliderAxCrazyEntity, Modelfury_slider_ax_crazy<FurySliderAxCrazyEntity>> {
    private static final ResourceLocation LOCATION = new ResourceLocation(JVPillage.MODID, "textures/entity/illager/fury_slider_ax_crazy.png");
    private static final ResourceLocation GLOW_LOCATION = new ResourceLocation(JVPillage.MODID, "textures/entity/illager/fury_slider_ax_crazy_glow.png");
