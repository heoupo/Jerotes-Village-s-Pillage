...
public class DefectorRenderer extends HumanoidMobRenderer<DefectorEntity, Modelillager<DefectorEntity>> {
    private static final ResourceLocation LOCATION = new ResourceLocation(JVPillage.MODID, "textures/entity/defector.png");
    private static final ResourceLocation ENEMY_LOCATION = new ResourceLocation(JVPillage.MODID, "textures/entity/defector_enemy.png");
