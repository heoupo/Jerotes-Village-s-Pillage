...
import com.jerotes.jvpillage.client.model.Modelsubmariner;
import com.jerotes.jvpillage.config.OtherMainConfig;
import com.jerotes.jvpillage.entity.Monster.IllagerFaction.SubmarinerEntity;
...
public class SubmarinerRenderer extends HumanoidMobRenderer<SubmarinerEntity, Modelsubmariner<SubmarinerEntity>> {
    private static final ResourceLocation LOCATION = new ResourceLocation(JVPillage.MODID, "textures/entity/illager/submariner.png");
