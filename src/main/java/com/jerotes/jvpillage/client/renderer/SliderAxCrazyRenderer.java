...
public class SliderAxCrazyRenderer extends HumanoidMobRenderer<SliderAxCrazyEntity, Modelslider_ax_crazy<SliderAxCrazyEntity>> {
    private static final ResourceLocation LOCATION = new ResourceLocation(JVPillage.MODID, "textures/entity/illager/slider_ax_crazy.png");
    private static final ResourceLocation GLOW_LOCATION = new ResourceLocation(JVPillage.MODID, "textures/entity/illager/slider_ax_crazy_glow.png");
