...
import com.jerotes.jvpillage.client.layer.SlaverySupervisorArmorLayer;
...
public class SlaverySupervisorRenderer extends MobRenderer<SlaverySupervisorEntity, Modelslavery_supervisor<SlaverySupervisorEntity>> {
    private static final ResourceLocation LOCATION = new ResourceLocation(JVPillage.MODID, "textures/entity/illager/slavery_supervisor.png");
    private static final ResourceLocation ARMOR_LOCATION = new ResourceLocation(JVPillage.MODID, "textures/entity/illager/slavery_supervisor_armor.png");
    private static final ResourceLocation ILLAGER_WITHER_LOCATION = new ResourceLocation(JVPillage.MODID, "textures/entity/illager/slavery_supervisor_noble_by_illager_wither.png");
