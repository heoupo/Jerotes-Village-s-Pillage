...
import com.jerotes.jvpillage.client.model.Modelfire_spitter;
...
public class FireSpitterRenderer extends HumanoidMobRenderer<FireSpitterEntity, Modelfire_spitter<FireSpitterEntity>> {
    private static final ResourceLocation LOCATION = new ResourceLocation(JVPillage.MODID, "textures/entity/fire_spitter.png");
