...
import com.jerotes.jvpillage.client.model.Modelunclean_tentacle;
...
public class UncleanTentacleRenderer extends MobRenderer<UncleanTentacleEntity, Modelunclean_tentacle<UncleanTentacleEntity>> {
    private static final ResourceLocation LOCATION = new ResourceLocation(JVPillage.MODID, "textures/entity/unclean_tentacle.png");
