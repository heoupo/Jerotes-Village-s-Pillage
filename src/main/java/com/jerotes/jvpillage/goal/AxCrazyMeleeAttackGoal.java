...
public class AxCrazyMeleeAttackGoal extends JerotesMeleeAttackGoal {
    ...
    public AxCrazyMeleeAttackGoal(PathfinderMob pathfinderMob, double d, boolean bl) {
