...
public class SpirveOrHagAttackTargetGoal<T extends LivingEntity> extends TargetGoal {
    ...
    public boolean canUse() {
        ...
        this.findTarget();
        boolean helmet = this.target != null && (this.target.getItemBySlot(EquipmentSlot.HEAD).getItem() == JVPillageItems.SPIRVE_HELMET.get() || this.target.getItemBySlot(EquipmentSlot.HEAD).getItem() == JVPillageItems.SPIRVE_HEAD.get());
        boolean chestplate = this.target != null && this.target.getItemBySlot(EquipmentSlot.CHEST).getItem() == JVPillageItems.SPIRVE_CHESTPLATE.get();
        boolean legs = this.target != null && this.target.getItemBySlot(EquipmentSlot.LEGS).getItem() == JVPillageItems.SPIRVE_LEGGINGS.get();
        boolean feet = this.target != null && this.target.getItemBySlot(EquipmentSlot.FEET).getItem() == JVPillageItems.SPIRVE_BOOTS.get();
